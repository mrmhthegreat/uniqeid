...
import 'package:amazone/animationsplash/fadein.dart';
import 'package:amazone/animationsplash/scaleanimation.dart';
import 'package:amazone/animationsplash/types.dart';
...
class _FlutterSplashScreenState extends State<FlutterSplashScreen> {
  ...
  Widget build(BuildContext context) {
    if (widget.splashType == SplashType.fadeIn) {
      return FadeInSplash()
